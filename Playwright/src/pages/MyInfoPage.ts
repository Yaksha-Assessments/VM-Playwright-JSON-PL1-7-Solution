 ...
 */
  ...
  async editQualification(editInput: string){
    ...
    await this.qualificationBtn.click();
    await this.editBtn.nth(0).waitFor({ state: 'visible' });
    await this.page.waitForTimeout(1000);
    await this.editBtn.nth(1).click();
    await this.compInput.nth(1).waitFor({ state: 'visible' });
    await this.page.waitForTimeout(1000);
 ...
 */
  ...
  async editSkills(year : number){
   ...
   await this.tableYear.nth(2).locator("//div[@class= 'oxd-table-card']").locator("//i[@class='oxd-icon bi-pencil-fill']").nth(1).click();
    await this.yearInput.nth(2).waitFor({ state: 'visible' });
    await this.page.waitForTimeout(1000);
 ...
 */
  ...
  async deleteLanguage(editComment : string){
    ...
    await this.page.waitForTimeout(1000);
    await this.qualificationBtn.click();
    await this.expAddbtn.nth(3).waitFor({state:'visible'})
    await this.page.waitForTimeout(1000);
    await this.expAddbtn.nth(3).click();
    await this.selectDropdown.nth(0).waitFor({state:'visible'})
    await this.page.waitForTimeout(1000);
    await this.selectDropdown.nth(0).click();
    await this.page.keyboard.press('ArrowDown');
    await this.page.keyboard.press('Enter');
    ...
    await this.saveQualiBtn.click();
    await this.page.locator(`xpath=//div[text()='${editComment}']/ancestor::div[contains(@class,'oxd-table-row')]//div[@class='oxd-table-cell-actions']/button[1]`).waitFor({state:'visible'})
    await this.page.waitForTimeout(1000);
